...
describe('User Utils - Unit Tests', () => {
  ...
  describe('filterUsers', () => {
    ...
    test('should return empty array for no matches', () => {
      const result = (0, _userUtils.filterUsers)(mockUsers, 'NonExistent');
    ...
    test('should handle users with missing properties', () => {
      ...
      const result = (0, _userUtils.filterUsers)(usersWithMissingProps, 'John');
      expect(result).toHaveLength(1);
      expect(result[0].name).toBe('John');
      const result2 = (0, _userUtils.filterUsers)(usersWithMissingProps, 'TestCity');
    ...
    test('should handle legacy format users (firstName/lastName)', () => {
      ...
      const result = (0, _userUtils.filterUsers)(legacyUsers, 'John');
      expect(result).toHaveLength(1);
      expect(result[0].firstName).toBe('John');
      const result2 = (0, _userUtils.filterUsers)(legacyUsers, 'New York');
      expect(result2).toHaveLength(1);
    ...
    test('should handle mixed format users', () => {
      ...
      const result = (0, _userUtils.filterUsers)(mixedUsers, 'Alice');
      expect(result).toHaveLength(1);
      expect(result[0].name).toBe('Alice Dupont');
      const result2 = (0, _userUtils.filterUsers)(mixedUsers, 'Bob');
      expect(result2).toHaveLength(1);
    ...
    test('should handle users with completely undefined properties', () => {
      ...
      // no name, email, address, city properties
      {
        id: 2,
        name: null,
        email: null,
      ...
      const result = (0, _userUtils.filterUsers)(usersWithUndefined, 'test');
  ...
  describe('sortUsersByName', () => {
    ...
    test('should handle legacy format users (firstName/lastName)', () => {
      ...
      const result = (0, _userUtils.sortUsersByName)(legacyUsers);
    ...
    test('should handle mixed format users', () => {
      ...
      const result = (0, _userUtils.sortUsersByName)(mixedUsers);
    ...
    test('should handle users with undefined names', () => {
      ...
      const result = (0, _userUtils.sortUsersByName)(usersWithUndefined);
    ...
    test('should handle users with null names', () => {
      ...
      const result = (0, _userUtils.sortUsersByName)(usersWithNullNames);
      expect(result).toHaveLength(2);
    });
    test('should handle empty arrays', () => {
      const result = (0, _userUtils.sortUsersByName)([]);
      expect(result).toEqual([]);
      const resultDesc = (0, _userUtils.sortUsersByName)([], 'desc');
  ...
  describe('userExists', () => {
    ...
    test('should handle null/undefined email inputs', () => {
      const result1 = (0, _userUtils.userExists)(null, mockUsers);
      expect(result1).toBe(false);
      const result2 = (0, _userUtils.userExists)(undefined, mockUsers);
      expect(result2).toBe(false);
      const result3 = (0, _userUtils.userExists)('', mockUsers);
    ...
    test('should handle users with null/undefined email properties', () => {
      ...
      const result1 = (0, _userUtils.userExists)('bob@test.com', usersWithNullEmails);
      expect(result1).toBe(true);
      const result2 = (0, _userUtils.userExists)('john@test.com', usersWithNullEmails);
      expect(result2).toBe(false);
    });
    test('should handle empty string email', () => {
      ...
      const result1 = (0, _userUtils.userExists)('', usersWithEmptyEmail);
      expect(result1).toBe(true);
      const result2 = (0, _userUtils.userExists)('jane@test.com', usersWithEmptyEmail);
      expect(result2).toBe(true);
    });
    test('should handle empty arrays and undefined inputs', () => {
      expect((0, _userUtils.userExists)('test@test.com', [])).toBe(false);
      expect((0, _userUtils.userExists)('test@test.com', undefined)).toBe(false);
      expect((0, _userUtils.userExists)('test@test.com')).toBe(false);
    });
  });
  ...
  describe('saveUsersToStorage', () => {
    ...
    test('should handle localStorage errors during setItem', () => {
      ...
      expect(() => (0, _userUtils.saveUsersToStorage)([{
        firstName: 'Test',
        lastName: 'User'
      }])).not.toThrow();
    ...
    test('should handle edge cases for formatUserCountText', () => {
      expect((0, _userUtils.formatUserCountText)(2)).toBe('2 utilisateurs inscrits');
      expect((0, _userUtils.formatUserCountText)(100)).toBe('100 utilisateurs inscrits');
      expect((0, _userUtils.formatUserCountText)(-1)).toBe('-1 utilisateurs inscrits'); // edge case
    });
  });
});