...
function _toPrimitive(t, r) { if ("object" != typeof t || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != typeof i) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); } // Auto-save feature version 2.0.0 - BREAKING CHANGE: New callback payload structure
...
function RegistrationForm(_ref) {
  ...
  const handleSubmit = async e => {
    ...
    const registrationPayload = {
      userData: newUser,
      // User data moved to userData property
      metadata: {
